...
public:
	...
	TEST_METHOD(TestMethod3) {	// 直线与圆相切
		PlaneContainer pc;
	...
	TEST_METHOD(TestMethod4) {	// 直线与圆相交
		PlaneContainer pc;
		pc.insert(new Line(0, 0, 0, 2, SL));
	...
	TEST_METHOD(TestMethod5) {	// 直线与圆无交点
		PlaneContainer pc;
		pc.insert(new Line(0, 0, 0, 2, SL));
